...
class InMemoryContractTest : TardigradeContractTest() {
    override fun setup() {}
    ...
    override fun initComponents(
        ...
        bulkheads.forEach {
            define.bulkhead(it.name, it.maxConcurrentCalls, it.maxWaitDuration)
        }
    }

    override fun teardown() = Tardigrade.reset()
}
